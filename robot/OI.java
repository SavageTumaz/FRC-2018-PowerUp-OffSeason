...
public class OI {
	...
	public OI(){
		...
		Abutton3.whenPressed(new ShooterPinch());
		Abutton4.whenPressed(new ShooterRelease());
	...
	/*	Abutton7.whenPressed(new ShooterLifterUp(8000));
		...
		Bbutton4.whileHeld(new EjectBlock(1.0));
		Bbutton4.whenReleased(new StopCollecting());
		Bbutton1.whileHeld(new CollectBlock(1.0));
		Bbutton1.whenReleased(new StopCollecting());
		Bbutton2.whenPressed(new ShooterPinch());
		Bbutton3.whenPressed(new ShooterRelease());		
